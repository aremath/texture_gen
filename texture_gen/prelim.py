...
def texture_gen(filename, outputFilename="out.png", size=(60, 60), tilesize=(5,5)):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tw", required=True)
    ...
    tw = int(args.tw)
    th = int(args.th)
    out = texture_gen(args.orig, args.out, (w,h), (tw, th))
    out.save(args.out)
